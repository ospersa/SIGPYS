...
require_once('../Controllers/ctrl_infSeguimiento.php');
?>
<div id="container" class="center-align">
    <h4>INFORME DE EJECUCIONES POR PROYECTO</h4>
    <div class="row">
        <form action="../Controllers/ctrl_infSeguimiento.php" method="post" id="form">
            <div class="row">
            ...
            <div class="row">
                <div class="input-field col l2 m2 s12 offset-l4 offset-m4">
                    <button class="btn waves-effect waves-light" type="button" name="btnBuscar"
                        onclick="buscar('../Controllers/ctrl_infSeguimiento.php');">Buscar</button>
                </div>
