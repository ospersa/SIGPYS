...
<div class="row search">
    <input id="txt-search" name="txt-search" class="hide" type="search" placeholder="Buscar" autocomplete="off" data-url="../Controllers/ctrl_periodo.php">
    <button id="btn-search" class="btn" onclick="busqueda('../Controllers/ctrl_periodo.php')">
