<div class="modal-content center-align">
	...
	<div class="row">
		<form id="actForm" action="../Controllers/ctrl_departamento.php" method="post" class="col l12 m12 s12">
			...
			<button class="btn waves-effect red darken-4 waves-light " type="submit" name="btnEliDepa">Eliminar</button>
			<button class="btn waves-effect waves-light" type="submit" name="btnActDepa">Actualizar</button>
		</form>
	</div>
</div>