<div class="modal-content center-align">
    ...
    <div class="row">
        <form id="actForm" action="../Controllers/ctrl_solicitud.php" method="post" class="col l12 m12 s12">
            ...
            <div class="row">
                <div class="input-field col l12 m12 s12">
                    <input name="txtFechPrev2" id="txtFechPrev2" type="date" value="<?php echo $fechPrev;?>">
                    <label for="txtFechPrev2">Fecha prevista entrega</label>
                </div>
            </div>
            <div class="row">
                <div class="input-field col l12 m12 s12">
                    <textarea name="txtObservacion2" id="txtObservacion2" class="materialize-textarea textarea"><?php echo $observacion;?></textarea>
            ...
            <div class="row">
                    <button class="btn waves-effect waves-light" type="submit" name="btnActualizarSolIni">Actualizar</button>
            </div>
        </form>
    </div>
</div>