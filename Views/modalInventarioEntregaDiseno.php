...
<div class="row">
    ...
    <div id="test1" class="col s12 tab-container">
        <form id="actForm" action="../Controllers/ctrl_inventario.php" method="post">
            ...
            <div class="input-field col l6 m6 s12 ">
                <input id="txtDesCarp" name="txtDesCarp" type="text" class="validate"
                    value="<?php echo $desCarp;?>">
                <label for="txtDesCarp" class="active">Desarrollo - Carpeta</label>
            </div>
            <div class="input-field col l6 m6 s12 ">
                <input id="txtDesPeso" name="txtDesPeso" type="text" class="validate"
                    value="<?php echo $desPeso;?>">
                <label for="txtDesPeso" class="active">Desarrollo - Peso</label>
            </div>
