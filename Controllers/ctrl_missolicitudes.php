...
$sltAreaConocimiento    = (isset($_POST['sltAreaConocimiento'])) ? $_POST['sltAreaConocimiento'] : null;
...
if($id) {
    ...
    if ($validarSer == True){
        ...
        $idAreaConocimiento     = $info2['idAreaConocimiento'];
        ...
        $sltAreaConocimiento    = SolicitudEspecifica::selectAreaConocimiento ($proyId, $idAreaConocimiento);
    }
}
...
if (isset($_POST['btnInactivar'])) {
    ...
    if ($compro == False) {
        SolicitudEspecifica::guardarResultadoSoporte ($idSol, $usuario, $nomProduc, $fechaEntre, $red, $idPlat, $idClProd, $idTipoPro, $url, $labor, $palabrasClave, $sltIdioma, $sltFormato, $sltTipoContenido, $sltAreaConocimiento);
    } else {
        SolicitudEspecifica::actualizarResultadoSoporte($idSol, $usuario, $nomProduc, $fechaEntre, $red, $idPlat, $idClProd, $idTipoPro, $url, $labor, $palabrasClave, $sltIdioma, $sltFormato, $sltTipoContenido, $sltAreaConocimiento);
    }
    ...
    $compro = SolicitudEspecifica::comprobraExisResultadoProductos($idSol);
    if ($compro == False){
        SolicitudEspecifica::guardarResultadoRealizacion ($idSol, $usuario, $nomProduc, $fechaEntre, $red, $idPlat, $idClProd, $idTipoPro, $url, $labor,$sinopsis, $autores, $urlVimeo, $minDura, $segDura, $palabrasClave, $sltIdioma, $sltFormato, $sltTipoContenido, $sltAreaConocimiento);
    } else{
        SolicitudEspecifica::actualizarResultadoRealizacion($idSol, $usuario, $nomProduc, $fechaEntre, $red, $idPlat, $idClProd, $idTipoPro, $url, $labor,$sinopsis, $autores, $urlVimeo, $minDura, $segDura, $palabrasClave, $sltIdioma, $sltFormato, $sltTipoContenido, $sltAreaConocimiento);
    }
}
