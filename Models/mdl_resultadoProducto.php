            ...
            if ($registros > 0) {
                ...
                while ($datos = mysqli_fetch_array($resultado)) {
                    ...
                    $string .= '    <tr>
                                        ...
                                        <td>'.$datos['fechSol'].'</td>
                                        <td><a href="#modalResulProTer" data-position="right" class="modal-trigger tooltipped" data-tooltip="Mas información del Producto" onclick="envioData(\''.$idSol.'\',\'modalResulProTer.php\')"><i class="material-icons teal-text">info_outline</i></a></td>
                                    </tr>';
                }
                $string .= '    </tbody>
                            </table>';
