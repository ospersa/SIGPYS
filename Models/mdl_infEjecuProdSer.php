    ...
    Class InformeEjecucion {
        ...
        public static function descarga ($proyecto, $fechaini, $fechafin) {
            ...
            if ($registros > 0) {
                ...
                $titulos=['Proyecto', 'Cod. Producto/servicio', 'Estado', 'Producto/servicio', 'Producto/servicio',	'Presupuesto', 'Producto/servicio', 'Asignado', 'Tiempo invertido', 'Valor Producto/Servicio'];
